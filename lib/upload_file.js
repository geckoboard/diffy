var s3 = require('s3');
var BUCKET = process.env.HUBOT_S3_BUCKET;
var ACCESS_KEY = process.env.HUBOT_S3_ACCESS_KEY_ID;
var SECRET_KEY = process.env.HUBOT_S3_SECRET_ACCESS_KEY;
var REGION = process.env.HUBOT_S3_REGION;
